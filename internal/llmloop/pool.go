...
// diff-based review and full-file scan. It owns the chat completion
// conversation state, three-zone memory compression, tool-call dispatch
// (including async comment post-processing), and aggregate token / warning
// bookkeeping. Callers above this package render the initial messages and
// hand them in via Runner.RunMainTask.
//
...
// as Await, but scoped to one key.
