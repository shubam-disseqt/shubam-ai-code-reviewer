...
// streamIntegrityError is a stream-completeness failure detected while
// consuming an already-established SSE stream.
...
// completionsStreaming consumes an SSE completion.
func (c *OpenAIClient) completionsStreaming(ctx context.Context, params openai.ChatCompletionNewParams, opts ...openaiopt.RequestOption) (*ChatResponse, error) {
	return c.completionsStreamingInner(ctx, params, opts...)
}
