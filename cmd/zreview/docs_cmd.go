...
import (
	...
	"github.com/shubam-disseqt/z-code-reviewer/docs"
	"github.com/shubam-disseqt/z-code-reviewer/internal/docsserver"
)
...
non-loopback address, set ZREVIEW_DOCS_ALLOWED_HOSTS to a
